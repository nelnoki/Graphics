...
TriangleComponent::TriangleComponent(Game* game, LPCWSTR shader,
	std::vector<DirectX::XMFLOAT4> points, std::vector<int> indeces,
	std::vector<UINT> strides, std::vector<UINT> offsets) 
	: GameComponent(game), shaderSource(shader), points(points), indeces(indeces), strides(strides), offsets(offsets)   {}

void TriangleComponent::Initialize() {

	ID3DBlob* errorVertexCode = nullptr;

	auto res = D3DCompileFromFile(shaderSource,
		nullptr /*macros*/,
		nullptr /*include*/,
		"VSMain",
		"vs_5_0",
